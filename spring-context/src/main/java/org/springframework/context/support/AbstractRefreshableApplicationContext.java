...
public abstract class AbstractRefreshableApplicationContext extends AbstractApplicationContext {
	...
	protected DefaultListableBeanFactory createBeanFactory() {
		...
		// getInternalParentBeanFactory方法的具体实现可以参看AbstractApplicationContext
	 ...
	 * 这里是使用BeanDefinitionReader载入Bean的地方，因为允许多种载入方式
	 * 虽然用的最多的是xml定义的形式，这通过一个抽象函数
	 * 把具体的实现交给子类来完成
