...
public abstract class DataSourceUtils {
     ...
     *
     * 这里是取得数据库连接的调用，是通过doGetConnection完成的，这里执行了异常的转换操作
     *
    ...
    public static Connection doGetConnection(DataSource dataSource) throws SQLException {
        ...
        // 把对数据库的Connection操作放到事务管理器中进行管理，这里使用在TransactionSynchronizationManager中定义的
        // ThreadLocal变量来和线程绑定数据库连接
        // 如果TransactionSynchronizationManager中已经有了与当前线程绑定的数据库连接，
        // 那么直接取出来使用
        ...
        // 这里得到需要的数据库连接Connection，它是在Bean配置文件中定义好的
