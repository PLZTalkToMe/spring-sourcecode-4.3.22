...
public abstract class RdbmsOperation implements InitializingBean {
    ...
    public final void compile() throws InvalidDataAccessApiUsageException {
        // 如果没有执行过compile，执行改一下的代码，否则什么都不做，如果已经做过了compile
        // 在declareParameters时会抛出异常，所有没有异常抛出
        if (!isCompiled()) {
            if (getSql() == null) {
            ...
            // 调用compileInternal完成具体的compile过程，并设置compile标志位
            compileInternal();
            this.compiled = true;
