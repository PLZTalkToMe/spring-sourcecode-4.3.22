...
public class HibernateTransactionManager extends AbstractPlatformTransactionManager
    ...
    /**
     * 这里创建HibernateTransactionObject，这个HibernateTransactionObject是设置Session
     * 以及Datasource这些对象的地方
     *
     * @Date 2020/4/8 9:51
     */
    ...
    protected Object doGetTransaction() {
        ...
        // 从线程中取得SessionHolder，这个SessionHolder是在事务开始的时候与线程绑定的
        ...
        // 在Transaction中设置DataSource，这个DataSource也是与线程绑定的。
    ...
    protected void doBegin(Object transaction, TransactionDefinition definition) {
        ...
        // 如果没有创建SessionHolder，那么这里创建Hibernate的session，并把
        // 创建的Session放到SessionHolder中去。
        try {
            ...
            if (definition.isReadOnly() && txObject.isNewSession()) {
                ...
                // 当事务被设置成ReadOnly的时候，设置Session的FlushMode
    ...
    protected Object doSuspend(Object transaction) {
        HibernateTransactionObject txObject = (HibernateTransactionObject) transaction;
        txObject.setSessionHolder(null);
        // 把当前的SessionHolder从线程中和TransactionObject中释放出来
        SessionHolder sessionHolder =
                (SessionHolder) TransactionSynchronizationManager.unbindResource(getSessionFactory());
        // 把当前的Connection从线程中和TransactionObject中释放出来
    ...
    /**
     * 为事务提交做准备，如果配置成FlushBeforeCommit并且是新事务，flush Session中的数据，
     * 然后把FlushMode设置成MANUAL
     * @Date 2020/4/8 10:53
     */
    @Override
